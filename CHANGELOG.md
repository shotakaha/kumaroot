...
- **geant4/geant4-install.md**: ソースコードからビルドする方法
...
- **geant4/geant4-acrylic.md**: アクリルを作った
...
- **geant4/geant4-world.md**: 実験室を追加した
...
- **typst/typst-usage.md**: importを追加した
...
- **geant4/geant4-run.md**: メイン関数を追記した
- **geant4/geant4-mandatory-classes.md**: クラスの自作度を追記した
- **geant4/geant4-mandatory-classes.md**: 必須クラスを整理した
- **geant4/geant4-class-category.md**: 削除した
- **geant4/geant4-drivers.md**: 見出しを修正した
- **geant4/geant4-multithread.md**: 削除した
- **geant4/geant4-scoring.md**: スコアリングマネジャーを追記した
- **geant4/geant4-scoring.md**: 見出しを修正した
- **geant4/geant4-geometry.md**: ジオメトリの作り方を整理した
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-scoring.md**: スコアリングを追加した
- **geant4/geant4-run.md**: メイン関数を追記した
- **geant4-usage.md**: 目次に追加した
- **geant4/geant4-coding-guidelines.md**: 修正した
- **geant4/geant4-coding-guidelines.md**: クラスリファレンスの使い方に変更した
- **geant4/geant4-track.md**: ユーザーフックを追記した
- **geant4/geant4-step.md**: ユーザーフックを追記した
- **geant4/geant4-track.md**: G4Trackを追加した
- **geant4/geant4-step.md**: G4Stepを追記した
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-step.md**: ステップ（G4Step）を追加した
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-steppingaction.md**: ステッピングアクションを追加した
- **geant4/geant4-actioninitialization.md**: 必須／任意の設定を追加した
- **geant4/geant4-coding-guidelines.md**: 引数の接頭辞を追加した
- **geant4/geant4-actioninitialization.md**: ランマネージャーの設定を追加した
- **geant4/geant4-actioninitialization.md**: ヘッダーを追加した
- **geant4/geant4-actioninitialization.md**: ユーザーアクションを追加した
- **geant4/geant4-usage.md**: スコアリングを追加した
- **geant4/geant4-scoringmanager.md**: メッシュ作成を追加した
- **geant4/geant4-scoringmanager.md**: スコアラーを追加した
- **geant4/geant4-runmanager.md**: スレッド数を変更した
- **geant4/geant4-examples-b2.md**: トラッカーの設置方法
- **geant4/geant4-runmanager.md**: ランマネージャーに専念した
- **geant4/geant4-run.md**: 管理者の役割を整理した
- **geant4/geant4-examples-b2.md**: 確認したいことを並べてみた
- **geant4/geant4-examples-b2.md**: マクロの内容を読んでみた
- **geant4/geant4-examples-b2.md**: ビルドの説明を追加した
- **geant4/geant4-examples-b2.md**: 画像を追加した
- **geant4/geant4-examples-b2.md**: サンプルB2を追加した
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-run.md**: シミュレーションの流れを整理した
- **geant4/geant4-macro.md**: 表示レベルを確認した
- **geant4/geant4-macro.md**: 表示用マクロを追加した
- **geant4/geant4-macro.md**: トラック情報を追加した
- **geant4/geant4-macro.md**: マクロモードを追記した
- **geant4/geant4-batch.md**: バッチモードを追記した
- **geant4/geant4-batch.md**: バッチモードを追加した
- **geant4/geant4-run.md**: ランの構造を追加した
- **geant4/geant4-units.md**: 単位の扱いを整理した
- **geant4/geant4-class-category.md**: クラス構造を追加した
- **poetry.lock**: パッケージを更新した
- **geant4-examples-b1.md**: ディレクトリを追加した
- **geant4/geant4-examples-b1.md**: B1の内容を整理している
- **geant4/geant4-examples-b1.md**: exampleB1を読み直す
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-cpp.md**: cppガイドラインは別立てにした
- **g4examples/B1/src/PrimaryGeneratorAction.cc**: ボリューム名を変更した
- **geant4/geant4-plastic-scintillator.md**: 見た目の設定と有感領域の設定を追加した
...
- **geant4/geant4-coding-guidelines.md**: コード規約を追記した
- **geant4/geant4-runmanager.md**: 整理した
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-detectorconstruction.md**: 追記した
- **geant4/geant4-physicslist.md**: 相互作用モデルを追記した
- **geant4/geant4-hodoscope.md**: ホドスコープを作った
- **geant4/geant4-material.md**: 材料調達の方法を追記した
- **geant4/geant4-acrylic.md**: アクリルの光学特性を追加した
...
- **geant4/geant4-drivers.md**: ドライバーの確認
- **geant4/geant4-coding-guidelines.md**: 修正した
- **geant4/geant4-coding-guidelines.md**: ヘッダーファイルの読み込み順を追記した
- **geant4/geant4-coding-guidelines.md**: Googleのスタイルガイドを追加した
- **geant4/geant4-usage.md**: 可視化ツールについて知っておきたかった
- **geant4/geant4-drivers.md**: 整理した
- **geant4/geant4-drivers.md**: 自作の可視化ツールについて追記した
- **geant4/geant4-mandatory-classes.md**: 必須クラスを追加した
- **geant4/geant4-volume.md**: 論理ボリュームと物理ボリュームの概念を追記した
- **geant4/geant4-volume.md**: 構造体の作成手順を追加した
- **geant4/geant4-usage.md**: 目次を追加した
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-build.md**: 説明を修正した
- **geant4/geant4-detectorconstruction.md**: テンプレートを作りかけた
- **geant4/geant4-usage.md**: 目次を整理した
- **geant4/geant4-actioninitialization.md**: 入射粒子の設定を追加した
- **geant4/geant4-detectorconstruction.md**: 測定器の設計者を追加した
- **geant4/geant4-physicslist.md**: 相互作用のモデルを追加した
- **geant4/geant4-vismanager.md**: 可視化の担当者を追加した
- **geant4/geant4-uimanager.md**: 対話モードの管理者を追加した
- **geant4/geant4-detectorconstruction.md**: 内容を移動した
- **geant4/geant4-idle.md -> docs/source/geant4/geant4-uimanager.md**: 対話モードはUImanagerの仕事
...
- **geant4/geant4-usage.md**: 物質を追加した
- **geant4/geant4-material.md**: 石油を追加した
- **geant4/geant4-spack.md**: 可視化ツールが使えなかったことを追記した
- **geant4/geant4-install.md**: 手順を整理した
- **geant4/geant4-install-make.md**: ディレクトリ構成を確認した
- **geant4/geant4-install-download.md**: ダウンロードを整理した
- **geant4/geant4-install-cmake.md**: cmakeを整理した
- **geant4/geant4-install-ccmake.md**: 画像を追加した
- **geant4/geant4-install-brew.md**: タイポを修正した
- **geant4/geant4-install-mkdir.md**: 作業ディレクトリの使い方を整理した
- **geant4/geant4-install-brew.md**: 外部ツールのインストールを追加した
- **geant4/geant4-install.md**: 目次を整理した
- **geant4/geant4-cmake.md**: 内容を整理した
- **geant4/geant4-install.md**: インストール手順の進め方を追記した
- **geant4/geant4-install.md**: 環境変数の設定を修正した
- **geant4/geant4-install-mkdir.md**: 作業ディレクトリ作成を分割した
- **geant4/geant4-install-download.md**: ダウンロード部分を分割した
- **geant4/geant4-install-ccmake.md**: ビルドの下準備を分割した
- **geant4/geant4-install-qt.md**: Qt5の設定を分割した
- **geant4-install-make.md**: ビルド部分を分割した
- **geant4/geant4-spack.md**: spackを使ったインストール方法
- **geant4/geant4-usage.md**: 目次を追加した
- **geant4/geant4-examples-b1.md**: マネージャーをかき集めた
- **geant4/geant4-examples-b1.md**: ユーザーアクションを追加した
- **geant4/geant4-examples-b1.md**: 材料を確認した
- **geant4/geant4-coding-guidelines.md**: k, fを追加した
- **geant4/geant4-tank.md**: コンパイルが通るように修正した
- **geant4/geant4-material.md**: toctreeを追加した
- 微修正
- **geant4/geant4-acrylic.md**: アクリルはPMMAのこと
- **geant4-acrylic.md**: プレキシガラスがNISTにあった
- **geant4-coding-guidelines.md**: クラス名の命名規則を追記した
- **geant4/geant4-coding-guidelines.md**: リネームした
- **geant4/geant4-world.md**: 単位の書き方を追記した
- **geant4/geant4-convention.md**: 公式のコーディング規約を追加した
- **geant4/geant4-material.md**: 素粒子・原子核実験の材料を追加した
- **geant4/geant4-usage.md**: 目次を更新した
- **geant4/geant4-runmanager.md**: RunManagerを追加した
- **geant4/geant4-usage.md**: Geant4講習会を追記した
- **geant4/geant4-build.md**: アプリ実行を追記した
- **geant4/geant4-usage.md**: 目次を更新した
- **geant4/geant4-install.md**: 環境変数の設定を追記した
- **geant4/geant4-install.md**: 利用可能なバージョンを追加した
- **geant4/geant4-install.md**: インストールされる依存パッケージを確認した
- **command/command-spack.md**: 追記した
- **command/command-spack.md**: loadを追記した
- **command/command-spack.md**: gcを追記した
- **command/command-spack.md**: コンパイラーを追記した
- **command/command-spack.md**: spackを追加した
- **geant4/geant4-usage.md**: 目次を追加した
- **myst/myst-templates.md**: リダイレクトを修正した
- **myst/myst-quickstart.md**: リダイレクトを修正した
- **typst/typst-heading.md**: リンク切れを修正した
- **python/python-install.md**: リンク切れを修正した
- **hugo/hugo-printf.md**: リンク切れを修正した
- **command/command-myst.md**: リダイレクトを修正した
- **typst/typst-par.md**: リンク切れを修正した
...
- **command/command-usage.md**: Homebrewの日本語ページを修正した
- **pandas/pandas-usage.md**: 目次を追加した
- **pandas/pandas-plot.md**: pandasでグラフ作成を追記した
...
- **pandas/pandas-matplotlib.md**: pandas-plotに統合した
- **pandas/pandas-plot.md**: pandas-matplotlibから移動した
- **pandas/pandas-plot.md**: 見出しにオプション名を追記した
- **pandas/pandas-matplotlib.md**: pandasの機能にフォーカスした
...
- **mystmd/matplotlib.ipynb**: subplot_mosaicのサンプルを追加した
- **pandas/pandas-matplotlib.md**: キャンバスの分割を追記した
- **mystmd/matplotlib.ipynb**: サンプルを追加した
- **pandas/pandas-usage.md**: タイポを修正した
- **pandas/pandas-matplotlib.md**: 内容を整理中
- **mystmd/matplotlib.ipynb**: matplotlibのサンプルを追記した
- **pandas/pandas-install.md**: scikit-learnを追加した
- **pandas/pandas-usage.md**: matplotlib設定を追記した
- **pandas/pandas-matplotlib.md**: plt.gcfを追記した
- **pandas/pandas-matplotlib.md**: ROOTとの連想を追記した
...
- **pandas/pandas-plot-hist.md**: TH1クラスを真似してみた
- **pandas/pandas-plot-scatter.md**: 散布図を別ページにした
- **pandas/pandas-plot.md**: サブプロットを追記した
- **pandas/pandas-plot-hist.md**: ヒストグラム作成を別ページにした
- **pandas/pandas-plot.md**: 積み上げヒストグラムを追加した
- **pandas/pandas-plot.md**: pandas.DataFrame.plotでできることを追加した
- **pandas/pandas-plot.md**: プロットの説明を整理した
- **mystmd/matplotlib.ipynb**: matplotlibの描画サンプルを追記した
...
- **typst/typst-page.md**: 空白を削除した
- **typst/typst-page.md**: ノンブルを追記した
- **typst/typst-page.md**: columnsを追記した
- **typst/typst-page.md**: marginを追記した
- **typst/typst-page.md**: flippedを追記した
- **typst/typst-page.md**: 用紙サイズを追記した
- **typst/typst-document.md**: タイトルを作ってみた
- **typst/typst-text-color.md**: 見出しを整理した
- **typst/typst-usage.md**: 目次を整理した
- **docs/source/conf.py**: typstのコードブロックの番号付を追加した
...
- **raspi/raspi-hardware.md**: モデルごとのIFの違いを追記した
