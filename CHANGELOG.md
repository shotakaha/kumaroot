...
- **command/command-ping.md**: pingを追加した
...
- **.gitignore**: LaTeX文書に関連するファイルを除外した
...
- **docs/source/_static/latex/packages/bxjalipsum.tex**: bxjalipsumのサンプルを追加した
- **docs/source/_static/latex/packages/fancyhdr.tex**: 修正した
- **docs/source/_static/latex/packages/fontspec.tex**: fontspecのサンプルを更新した
- **index.md**: 公開先のURLを追加した
