...
- **_static/latex/templates/lualatex-jlreq/main.tex**: サンプルを更新した
...
- **latex/latex-usage.md**: 内容を整理した
- **latex/latex-usage.md**: 目次を整理した
- **latex/latex-bibliography.md**: 参考文献する方法を整理した
- **sphinx/sphinx-extensions-myst.md**: sphinx-designでタブにした
- **索引**: 設定したい
- **索引**: 索引したい
- **索引**: 目次したい
- **索引**: 検索＆置換したい
- **latex/latex-install.md**: カスタマイズを追記した
- **latex/latex-install.md**: texdocを追記した
- **sphinx/sphinx-syntax-index.md**: PDFの索引を追記した
- **sphinx/sphinx-syntax-index.md**: その他の種類の索引を追記した
- **command/command-xargs.md**: xargsを追記した
- **command/command-brew.md**: フォント一覧を追加した
- **command/command-fd.md**: 索引にRust代替コマンドを追加した
- **sphinx/sphinx-syntax-index.md**: indexを追記した
- **sphinx/sphinx-syntax-index.md**: indexを追記した
- **latex/latex-install.md**: tlmgrを追記した
- **myst/myst-usage.md**: 未作成のページをコメントアウトした
- **docs/source/index.md**: 微修正した
- **indexed**: 索引に追加した
- タイトルを微修正した
- **myst/myst-usage.md**: 索引に追加した
...
- **sphinx/sphinx-extensions-ablog.md**: タイポを修正
